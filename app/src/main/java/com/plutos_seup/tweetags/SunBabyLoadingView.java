...
public class SunBabyLoadingView extends View {
     ...
     * 画笔的颜色
     */
    private static final String PAINT_COLOR = "#676668";
     ...
     * 太阳光芒的长度
     */
    private static final float SUNSHINE_LINE_LENGTH = 30;
     ...
     * 太阳眼睛的半径
     */
    private static final float SUN_EYES_RADIUS = 12;
    ...
    private void drawUnderLineView(Canvas canvas) {
        ...
        canvas.drawText("Loading", textX, textY, mTextPaint);
        canvas.restore();
    }
